...
var Config = import_koishi3.Schema.intersect([
  import_koishi3.Schema.object({
    ...
    timezone: import_koishi3.Schema.union([
      import_koishi3.Schema.const(1).description("东一区（+1）"),
      import_koishi3.Schema.const(2).description("东二区（+2）"),
      import_koishi3.Schema.const(3).description("东三区（+3）"),
      import_koishi3.Schema.const(4).description("东四区（+4）"),
      import_koishi3.Schema.const(5).description("东五区（+5）"),
      import_koishi3.Schema.const(6).description("东六区（+6）"),
      import_koishi3.Schema.const(7).description("东七区（+7）"),
      import_koishi3.Schema.const(8).description("东八区（+8）"),
      import_koishi3.Schema.const(9).description("东九区（+9）"),
      import_koishi3.Schema.const(10).description("东十区（+10）"),
      import_koishi3.Schema.const(11).description("东十一区（+11）"),
      import_koishi3.Schema.const(12).description("东十二区（+12）"),
      import_koishi3.Schema.const(-1).description("西一区（-1）"),
      import_koishi3.Schema.const(-2).description("西二区（-2）"),
      import_koishi3.Schema.const(-3).description("西三区（-3）"),
      import_koishi3.Schema.const(-4).description("西四区（-4）"),
      import_koishi3.Schema.const(-5).description("西五区（-5）"),
      import_koishi3.Schema.const(-6).description("西六区（-6）"),
      import_koishi3.Schema.const(-7).description("西七区（-7）"),
      import_koishi3.Schema.const(-8).description("西八区（-8）"),
      import_koishi3.Schema.const(-9).description("西九区（-9）"),
      import_koishi3.Schema.const(-10).description("西十区（-10）"),
      import_koishi3.Schema.const(-11).description("西十一区（-11）"),
      import_koishi3.Schema.const(-12).description("西十二区（-12）"),
      import_koishi3.Schema.const(0).description("UTC协调世界时（+0）")
