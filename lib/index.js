...
var Config = import_koishi2.Schema.intersect([
  import_koishi2.Schema.object({
    ...
    minplusnum: import_koishi2.Schema.number().default(1).description("每次签到的最小加分数量").required(),
    maxplusnum: import_koishi2.Schema.number().default(10).description("每次签到最大加分数量").required(),
